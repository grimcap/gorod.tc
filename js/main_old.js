...
if(g('body.page-schema')[0]){
	...
	function zoom(plan){
		...
		// var dist = 0;
		// var curr_scale = window.getComputedStyle(plan).transform.slice(7,-1).split(', ')[0];
		// var max_zoom = 8.0;
		// var min_zoom = 0.5;
		...
		// 	let tt = e.targetTouches;
		// 	if (scaling) {
		// 		planZoom(distance(tt[0], tt[1]) - dist);
		// 		// curr_scale = distance(tt[0], tt[1]) / dist * zoomStep;
		// 		// plan.style.WebkitTransform = "scale(" + curr_scale + ", " + curr_scale + ")";
		// 	}
		// })
		...
		// 		// 	}
		// 		// }
		// 		// plan.style.WebkitTransform = "scale(" + scale_factor + ", " + scale_factor + ")";
		// 	} else {
		// 		scaling = true;
		// 	}
		// })
